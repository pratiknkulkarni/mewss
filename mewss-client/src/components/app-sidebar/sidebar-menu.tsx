...
import {SidebarMenu as Menu, SidebarMenuButton, SidebarMenuItem} from "@/components/ui/sidebar"
...
export function SidebarMenu({
    ...
    return (
        <>
            ...
            {/*I have lifted this up in the index for working with the shortkey*/}
            {/*<FeedModal isOpen={isAddModalOpen} onClose={() => setIsAddModalOpen(false)} onFeedCreated={onFeedCreated} />*/}
        </>
    )
}